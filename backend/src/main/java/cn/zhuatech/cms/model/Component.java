...
@Entity @Table(name="cms_component") public class Component extends BaseEntity {
    ...
    protected Component(){} public Component(String code,String name,Site site,Status status,int oee){this.code=code;this.name=name;this.site=site;this.status=status;this.oee=oee;this.lastHeartbeat=LocalDateTime.now();}
