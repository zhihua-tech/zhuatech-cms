...
@Entity @Table(name="cms_component") public class Component extends BaseEntity {
    ...
    protected Component(){} /**
                             * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
                             */
public Component(String code,String name,Site site,Status status,int oee){this.code=code;this.name=name;this.site=site;this.status=status;this.oee=oee;this.lastHeartbeat=LocalDateTime.now();}
    /**
     * 商业授权或定制开发请微信添加微信号zhuatech或zhuatech2进行咨询。
     */
